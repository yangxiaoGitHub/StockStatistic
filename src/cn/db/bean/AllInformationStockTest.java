...
public class AllInformationStockTest extends BaseStock {
	private static final long serialVersionUID = -4268828792895079655L;

	private String stockInfo;
	private String stockInfoDES;
	private String stockInfoMD5;

	public final static String TABLE_NAME = "ALL_INFORMATION_STOCK_TEST_";
	...
	public final static String ALL_FIELDS = NUM + "," + STOCK_CODE + "," + STOCK_DATE + "," + STOCK_INFO + "," + STOCK_INFO_DES + ","
			+ STOCK_INFO_MD5 + "," + INPUT_TIME;
